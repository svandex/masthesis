...
%%% 正文
\mainmatter
\include{chapter/1_intro_chapter}
\include{chapter/2_model_chapter}
\include{chapter/3_platformer_chapter}
%\include{chapter/4_ion_chapter}
%\include{chapter/5_validation_chapter}
%\include{chapter/6_conclusion_chapter}
